...
- switched from args only to args and `kwargs`

## Added

- Filter option `extensions` added, for filtering `file_paths` by file extensions (e.g .zig)

## [0.1.17] - 2025-11-28

## Removed

- Removed unnecessary dependency: `setuptools`
